        ...
        <div class="min-h-screen">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-[minmax(0,1.1fr)_420px] gap-10 items-center">
                        <div class="max-w-3xl">
                            ...
                            <div class="mt-8 flex flex-wrap gap-3">
                                ...
                                <a href="{{ $content['hero_deriv_url'] }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-5 py-3 rounded-md bg-slate-900 text-white text-sm font-semibold hover:bg-slate-800 dark:bg-brand-500 dark:hover:bg-brand-400">
                                    {{ $content['button_deriv_account'] }}
                                </a>
                                <a href="{{ $content['hero_weltrade_url'] }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-5 py-3 rounded-md border border-sky-300 bg-sky-50 text-sm font-semibold text-sky-800 hover:border-sky-400 hover:bg-sky-100 dark:border-sky-500/40 dark:bg-sky-500/10 dark:text-sky-300 dark:hover:border-sky-400 dark:hover:bg-sky-500/20">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative flex flex-col items-center justify-center px-4 py-6 sm:px-6 sm:py-8">
                                <img src="{{ asset('storage/'.$content['hero_image_light']) }}" alt="AET Trader Academy logo" class="mx-auto block w-full max-w-[280px] dark:hidden">
                                <img src="{{ asset('storage/'.$content['hero_image_dark']) }}" alt="AET Trader Academy logo dark" class="mx-auto hidden w-full max-w-[280px] dark:block">
                                <div class="mt-5 text-center max-w-sm">
                                    ...
                                    <p class="mt-1 text-sm text-gray-600 dark:text-graphite-300">{{ $content['hero_logo_caption'] }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative grid grid-cols-1 gap-8 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] xl:gap-10">
                            <div>
                                ...
                                <div class="program-fade-up mt-6 flex flex-wrap gap-3" style="animation-delay: 320ms;">
                                    <span class="inline-flex items-center rounded-full border border-white/12 bg-white/8 px-3 py-1 text-xs font-medium text-slate-100">{{ $content['programs_pill_1'] }}</span>
                                    <span class="inline-flex items-center rounded-full border border-white/12 bg-white/8 px-3 py-1 text-xs font-medium text-slate-100">{{ $content['programs_pill_2'] }}</span>
                                    <span class="inline-flex items-center rounded-full border border-white/12 bg-white/8 px-3 py-1 text-xs font-medium text-slate-100">{{ $content['programs_pill_3'] }}</span>
                                    <span class="inline-flex items-center rounded-full border border-white/12 bg-white/8 px-3 py-1 text-xs font-medium text-slate-100">{{ $content['programs_pill_4'] }}</span>
                                </div>
                                ...
                                <div class="mt-8 grid grid-cols-1 gap-5 lg:grid-cols-2">
                                    <article class="program-fade-up rounded-[1.6rem] border border-white/12 bg-white/8 p-5 shadow-[0_20px_50px_-34px_rgba(15,23,42,0.95)] backdrop-blur-md" style="animation-delay: 400ms;">
                                        <p class="text-xs font-semibold uppercase tracking-[0.24em] text-brand-200">{{ $content['program_card_1_eyebrow'] }}</p>
                                        <h3 class="mt-3 text-xl font-semibold text-white">{{ $content['program_card_1_title'] }}</h3>
                                        <p class="mt-3 text-sm leading-6 text-slate-300">{{ $content['program_card_1_desc'] }}</p>
                                        <div class="mt-6 grid gap-3">
                                            <div class="rounded-2xl border border-white/10 bg-slate-950/40 px-4 py-3 text-sm font-medium text-white">{{ $content['program_card_1_item_1_title'] }}</div>
                                            <div class="rounded-2xl border border-white/10 bg-slate-950/40 px-4 py-3 text-sm font-medium text-white">{{ $content['program_card_1_item_2_title'] }}</div>
                                            <div class="rounded-2xl border border-white/10 bg-slate-950/40 px-4 py-3 text-sm font-medium text-white">{{ $content['program_card_1_item_3_title'] }}</div>
                                        </div>
                                    </article>
                                    ...
                                    <article class="program-fade-up rounded-[1.6rem] border border-white/12 bg-slate-950/40 p-5 shadow-[0_20px_50px_-34px_rgba(15,23,42,0.95)] backdrop-blur-md" style="animation-delay: 480ms;">
                                        <p class="text-xs font-semibold uppercase tracking-[0.24em] text-emerald-200">{{ $content['program_card_2_eyebrow'] }}</p>
                                        <h3 class="mt-3 text-xl font-semibold text-white">{{ $content['program_card_2_title'] }}</h3>
                                        <p class="mt-3 text-sm leading-6 text-slate-300">{{ $content['program_card_2_desc'] }}</p>

                                        <div class="mt-6 space-y-3">
                                            <div class="rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                                                <p class="text-sm font-semibold text-white">{{ $content['program_card_2_item_1_title'] }}</p>
                                            </div>
                                            <div class="rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                                                <p class="text-sm font-semibold text-white">{{ $content['program_card_2_item_2_title'] }}</p>
                                            </div>
                                            <div class="rounded-2xl border border-white/10 bg-white/6 px-4 py-3">
                                                <p class="text-sm font-semibold text-white">{{ $content['program_card_2_item_3_title'] }}</p>
                                            </div>
                                        </div>
                                    </article>
                                </div>
                            ...
                            <aside class="program-fade-up relative rounded-[1.8rem] border border-white/12 bg-white/8 p-6 shadow-[0_20px_60px_-36px_rgba(15,23,42,0.95)] backdrop-blur-md" style="animation-delay: 560ms;">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-xs font-semibold uppercase tracking-[0.24em] text-slate-300">{{ $content['programs_panel_badge'] }}</p>
                                ...
                                <div class="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3 xl:grid-cols-1">
                                    <div class="rounded-2xl border border-white/10 bg-slate-950/40 px-4 py-4">
                                        <p class="text-xs uppercase tracking-[0.18em] text-slate-400">{{ $content['programs_stat_1_label'] }}</p>
                                        <p class="mt-2 text-sm font-semibold text-white">{{ $content['programs_stat_1_value'] }}</p>
                                    </div>
                                    <div class="rounded-2xl border border-white/10 bg-slate-950/40 px-4 py-4">
                                        <p class="text-xs uppercase tracking-[0.18em] text-slate-400">{{ $content['programs_stat_2_label'] }}</p>
                                        <p class="mt-2 text-sm font-semibold text-white">{{ $content['programs_stat_2_value'] }}</p>
                                    </div>
                                    <div class="rounded-2xl border border-white/10 bg-slate-950/40 px-4 py-4">
                                        <p class="text-xs uppercase tracking-[0.18em] text-slate-400">{{ $content['programs_stat_3_label'] }}</p>
                                        <p class="mt-2 text-sm font-semibold text-white">{{ $content['programs_stat_3_value'] }}</p>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <div class="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div class="rounded-xl border border-gray-200 dark:border-graphite-800 px-4 py-3">
                                    <p class="text-xs uppercase tracking-wide text-gray-500 dark:text-graphite-400">{{ $content['behind_focus_1_label'] }}</p>
                                    <p class="mt-1 text-sm font-medium text-gray-800 dark:text-graphite-100">{{ $content['behind_focus_1_value'] }}</p>
                                </div>
                                <div class="rounded-xl border border-gray-200 dark:border-graphite-800 px-4 py-3">
                                    <p class="text-xs uppercase tracking-wide text-gray-500 dark:text-graphite-400">{{ $content['behind_focus_2_label'] }}</p>
                                    <p class="mt-1 text-sm font-medium text-gray-800 dark:text-graphite-100">{{ $content['behind_focus_2_value'] }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <aside class="rounded-2xl border border-gray-200 dark:border-graphite-800 bg-gray-50 dark:bg-graphite-800/60 p-5 lg:sticky lg:top-24">
                            <div class="overflow-hidden rounded-2xl border border-gray-200 dark:border-graphite-700 bg-white dark:bg-graphite-900">
                                <div class="h-[360px] sm:h-[440px] lg:h-[420px] w-full bg-gray-100 dark:bg-graphite-900">
                                    <img src="{{ asset('storage/'.$content['behind_photo']) }}" alt="{{ $content['behind_person_name'] }} - AET Trader Academy" class="h-full w-full object-cover object-top">
                                </div>
                            </div>
                            <div class="mt-4">
                                <p class="text-sm font-semibold text-gray-900 dark:text-graphite-100">{{ $content['behind_person_name'] }}</p>
                                <p class="text-xs text-gray-600 dark:text-graphite-300">{{ $content['behind_badge'] }}</p>
                            </div>
                            <p class="mt-4 text-sm text-gray-600 dark:text-graphite-300">{{ $content['behind_quote'] }}</p>
                        </aside>
                    </div>
                </section>
                    ...
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1.1fr)_420px] lg:gap-10 items-start">
                            ...
                            <div class="mt-6">
                                <div x-show="contactTab === 'new'" x-transition.opacity.duration.250ms class="space-y-5">
                                    <div class="rounded-[1.6rem] border border-white/60 bg-white/85 p-5 shadow-[0_18px_50px_-34px_rgba(15,23,42,0.75)] backdrop-blur dark:border-graphite-700 dark:bg-graphite-900/85">
                                        <p class="text-xs font-semibold uppercase tracking-[0.22em] text-brand-700 dark:text-brand-300">{{ $content['contact_new_eyebrow'] }}</p>
                                        <h3 class="mt-3 text-xl font-semibold text-gray-900 dark:text-graphite-100">{{ $content['contact_new_title'] }}</h3>
                                        <p class="mt-3 text-sm leading-7 text-gray-600 dark:text-graphite-300">{{ $content['contact_new_description'] }}</p>
                                        ...
                                        <div class="mt-5 grid gap-3 sm:grid-cols-3">
                                            <div class="rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 dark:border-graphite-800 dark:bg-graphite-950/60">
                                                ...
                                                <p class="mt-2 text-sm font-semibold text-gray-900 dark:text-graphite-100">{{ $content['contact_new_step_1'] }}</p>
                                            </div>
                                            <div class="rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 dark:border-graphite-800 dark:bg-graphite-950/60">
                                                <p class="text-xs uppercase tracking-[0.18em] text-gray-500 dark:text-graphite-400">02</p>
                                                <p class="mt-2 text-sm font-semibold text-gray-900 dark:text-graphite-100">{{ $content['contact_new_step_2'] }}</p>
                                            </div>
                                            <div class="rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 dark:border-graphite-800 dark:bg-graphite-950/60">
                                                <p class="text-xs uppercase tracking-[0.18em] text-gray-500 dark:text-graphite-400">03</p>
                                                <p class="mt-2 text-sm font-semibold text-gray-900 dark:text-graphite-100">{{ $content['contact_new_step_3'] }}</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="grid gap-3 sm:grid-cols-2">
                                        <a href="{{ $content['contact_telegram_url'] }}" target="_blank" rel="noopener noreferrer" class="group flex items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 transition hover:border-brand-400 hover:bg-brand-50 dark:border-graphite-700 dark:bg-graphite-900 dark:hover:border-brand-700 dark:hover:bg-brand-950/20">
                                        ...
                                        <a href="mailto:{{ $content['contact_email'] }}" class="group flex items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 transition hover:border-brand-400 hover:bg-brand-50 dark:border-graphite-700 dark:bg-graphite-900 dark:hover:border-brand-700 dark:hover:bg-brand-950/20">
                                        ...
                                        <a href="https://wa.me/{{ $content['contact_whatsapp_number_raw'] }}" target="_blank" rel="noopener noreferrer" class="group flex items-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 transition hover:border-brand-400 hover:bg-brand-50 dark:border-graphite-700 dark:bg-graphite-900 dark:hover:border-brand-700 dark:hover:bg-brand-950/20">
                                ...
                                <div x-show="contactTab === 'trader'" x-transition.opacity.duration.250ms class="space-y-5" style="display: none;">
                                    <div class="rounded-[1.6rem] border border-slate-200 bg-slate-950 p-5 shadow-[0_18px_50px_-34px_rgba(15,23,42,0.95)] dark:border-brand-900/50">
                                        <p class="text-xs font-semibold uppercase tracking-[0.22em] text-brand-200">{{ $content['contact_trader_eyebrow'] }}</p>
                                        <h3 class="mt-3 text-xl font-semibold text-white">{{ $content['contact_trader_title'] }}</h3>
                                        <p class="mt-3 text-sm leading-7 text-slate-300">{{ $content['contact_trader_description'] }}</p>

                                        <div class="mt-5 space-y-3">
                                            <div class="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                                                <p class="text-sm font-semibold text-white">{{ $content['contact_trader_item_1_title'] }}</p>
                                                <p class="mt-1 text-sm leading-6 text-slate-300">{{ $content['contact_trader_item_1_desc'] }}</p>
                                            </div>
                                            <div class="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                                                <p class="text-sm font-semibold text-white">{{ $content['contact_trader_item_2_title'] }}</p>
                                                <p class="mt-1 text-sm leading-6 text-slate-300">{{ $content['contact_trader_item_2_desc'] }}</p>
                                            </div>
                                            <div class="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
                                                <p class="text-sm font-semibold text-white">{{ $content['contact_trader_item_3_title'] }}</p>
                                                <p class="mt-1 text-sm leading-6 text-slate-300">{{ $content['contact_trader_item_3_desc'] }}</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="grid gap-3 sm:grid-cols-2">
                                        <a href="https://wa.me/{{ $content['contact_whatsapp_number_raw'] }}?text={{ rawurlencode($content['contact_trader_ready_message']) }}" target="_blank" rel="noopener noreferrer" class="group flex items-center gap-3 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 transition hover:border-emerald-300 hover:bg-emerald-100 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:hover:border-emerald-400 dark:hover:bg-emerald-500/20 sm:col-span-2">
                        ...
                        <div class="relative overflow-hidden rounded-[1.8rem] border border-gray-200 bg-white p-4 sm:p-5 shadow-sm dark:border-graphite-700 dark:bg-graphite-900">
                            ...
                            <div x-show="contactTab === 'new'" x-transition.opacity.duration.250ms class="relative">
                                <p class="text-sm font-semibold text-gray-900 dark:text-graphite-100">{{ $content['contact_qr_title'] }}</p>
                                <p class="mt-1 text-xs leading-6 text-gray-600 dark:text-graphite-300">{{ $content['contact_qr_description'] }}</p>
                                ...
                                <div class="mt-4 rounded-xl overflow-hidden border border-gray-200 dark:border-graphite-700 bg-gray-50 dark:bg-graphite-800">
                                    <img src="{{ asset('storage/'.$content['contact_qr_image']) }}" alt="{{ $content['contact_qr_alt'] }}" class="w-full h-auto object-contain">
                                </div>

                                <a href="{{ $content['contact_telegram_url'] }}" target="_blank" rel="noopener noreferrer" class="mt-4 inline-flex items-center justify-center w-full px-4 py-3 rounded-xl bg-brand-600 text-white text-sm font-semibold hover:bg-brand-500">
                            ...
                            <div x-show="contactTab === 'trader'" x-transition.opacity.duration.250ms class="relative space-y-4" style="display: none;">
                                <div class="rounded-[1.4rem] border border-slate-200 bg-slate-950 p-5 dark:border-brand-900/50">
                                    <p class="text-xs font-semibold uppercase tracking-[0.2em] text-brand-200">{{ $content['contact_trader_side_badge'] }}</p>
                                    <h3 class="mt-3 text-xl font-semibold text-white">{{ $content['contact_trader_side_title'] }}</h3>
                                    <p class="mt-3 text-sm leading-7 text-slate-300">{{ $content['contact_trader_side_description'] }}</p>
                                </div>

                                <div class="rounded-[1.4rem] border border-emerald-200 bg-emerald-50 p-5 dark:border-emerald-500/30 dark:bg-emerald-500/10">
                                    <p class="text-sm font-semibold text-emerald-900 dark:text-emerald-200">{{ $content['contact_trader_ready_message_label'] }}</p>
            ...
            <footer class="border-t border-gray-200 bg-white dark:bg-graphite-900 dark:border-graphite-800">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-500 dark:text-graphite-400">
                    <p>&copy; {{ date('Y') }} {{ $content['footer_copyright_suffix'] }}</p>
                    ...
                    <nav class="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
                        ...
                        <a href="mailto:{{ $content['contact_email'] }}" class="hover:text-brand-600 dark:hover:text-brand-400">{{ $content['contact_email'] }}</a>
                        <a href="https://wa.me/{{ $content['contact_whatsapp_number_raw'] }}" class="hover:text-brand-600 dark:hover:text-brand-400">{{ $content['contact_whatsapp_number_display'] }}</a>
                    </nav>
                </div>
            </footer>
        </div>
